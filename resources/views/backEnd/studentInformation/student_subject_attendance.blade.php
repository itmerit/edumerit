...
<div class="container-fluid">
                    ...
                    <table style="width: 100%; table-layout: fixed" id="attendance">
                        <thead>
                                <tr>
                                    <th width="10px">SL</th>
                                    <th width="100px">@lang('common.name')</th>
                                    <th width="100px">@lang('student.admission_no')</th>
                                    <th width="20px">P</th>
                                    <th width="20px">L</th>
                                    <th width="20px">A</th>
                                    <th width="20px">F</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @for($i = 1; $i<=$days; $i++)
                                    ...
                                    @endphp
                                    @if(date('w', strtotime($date))>0)
                                        <td width="100px" class="{{($i<=18)? 'all':'none'}}">
                                            @php
                                                $date_present=0;
                                                $date_absent=0;
                                                $date_total_class=0;
                                            ...
                                            @if ($date_total_class != 0)
                                                ...
                                                <hr>
                                                @foreach($values as $value)
                                                    {{$value?->subject?->subject_code.":".$value->grade}}<br>
                                                @endforeach
                                            @endif
                                        </td>
                                    @endif
