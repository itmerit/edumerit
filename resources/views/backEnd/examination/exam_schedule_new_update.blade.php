                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mt-30-md">
                                <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                        name="exam_type">
                                    <option data-display="@lang('exam.select_exam') *"
                                            value="">@lang('exam.select_exam') *
                                    </option>
                                ...
                                <tr class="0" id="row_{{ $row }}">
                                    <td class="border-top-0">
                                        <div class="primary_input">
                                            <select class="primary_select" name="routine[{{ $row }}][subject]"
                                                    id="subject" data-rule-required="true" required>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <select class="primary_select  promote_class" readonly disabled
                                                        id="promote_class" name="routine[{{$row}}][class]" required>
                                                    <option data-display="@lang('common.select_class') *"
                                                            value="">@lang('common.select_class') *
                                                    </option>
                                                    @foreach($classes as $class)
                                    ...
                                    <td class="border-top-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12" id="promote_section_div">
                                                ...
                                                <select class="primary_select" name="routine[{{ $row }}][section]"
                                                        required>
                                    ...
                                    <td class="border-top-0">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input class="primary_input_field time start_time_required start_time form-control{{ @$errors->has('start_time') ? ' is-invalid' : '' }}"
                                    ...
                                    <td class="border-top-0">
                                        <div class="row no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input class="primary_input_field primary_input_field time end_time form-control{{ @$errors->has('end_time') ? ' is-invalid' : '' }}"
                                                           id="end_time_{{ $row }}" type="text"
                                                           name="routine[{{ $row }}][end_time]" data-row_id="{{ $row }}"
                                    ...
                                    <td class="border-top-0">
                                        <div class="row">
                                            <div class="col-lg-12 mt-30-md">
                                                <select class="primary_select  form-control"
                                                        name="routine[{{ $row }}][room]" id="room" required>
                                                    <option data-display="@lang('common.select_room') *"
                                                            value="">@lang('common.select_room') *
                                                    </option>
                                    ...
                                    <td class="border-top-0">
                                        ...
                                        @if(userPermission("delete-class-routine"))
                                            ...
                                            <button class="primary-btn icon-only fix-gr-bg removeExamRoutineRowBtn"
                                                    data-row_id="{{ $row }}" data-exam_routine_id="{{ $routine->id }}"
                                                    type="button">
